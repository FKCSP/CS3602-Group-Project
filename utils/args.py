...
def add_argument_base(arg_parser):
    ...
    arg_parser.add_argument('--seed', default=99999, type=int, help='Random seed')
    ...
    arg_parser.add_argument('--max_epoch', type=int, default=40, help='terminate after maximum epochs')
    #### Common Encoder Hyperparams ####
    arg_parser.add_argument('--encoder_cell', default='LSTM', choices=['LSTM', 'GRU', 'RNN'], help='root of data')
    arg_parser.add_argument('--dropout', type=float, default=0.1, help='feature dropout rate')
